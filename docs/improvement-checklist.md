...
export default function sitemap(): MetadataRoute.Sitemap {
  const posts = blogPosts.map((post) => ({
    url: `https://vanshajpoonia.com/blog/${post.slug}`,
  ...
  return [
    ...
    {
      url: 'https://vanshajpoonia.com/blog',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.9,
    },
...
<rss version="2.0">
  <channel>
    <title>Vanshaj Poonia Blog</title>
    <link>https://vanshajpoonia.com/blog</link>
    ...
    <item>
      ...
      <link>https://vanshajpoonia.com/blog/${post.slug}</link>
